...
export const OperatingPage = () => {
  ...
  const operatingDateLabel = (dateStr) => {
    // Operating results are published at the daily close time (18:00).
    // The incoming timestamp may not match the close time, so we render a fixed close-time label.
    return `${formatDate(dateStr, { time: false })} - 18:00 h`;
  };
